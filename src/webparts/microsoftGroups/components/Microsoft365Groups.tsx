  ...
  return <div className={styles.Container}>
    <div className={styles.tableCaptionStyle}>{this.state.title}
      <div>
        ...
        <button className={styles.SwitchGroups} onClick={() => this.SwitchGroupList()}>  {this.state.title === 'My Groups' ?
...
{   this.state.GroupResultsFiltered.map(Group => {
      ...
      <div className={styles.tableStyle}>
          <div style={{display:'table-row'}}>
            ...
            <button className={BackButton} disabled={this.state.Next === (this.state.GroupDisplay)} onClick={() => this.Back(this.state.GroupResultsFiltered)}>
            ...
            <button className={NextButton} disabled={this.state.Next >= this.state.GroupResultsFiltered.length} onClick={() => this.Next(this.state.GroupResultsFiltered)}>
